...
export const injectHeader = (activeTabId, currentUser, currentRestaurant) => {
  ...
  // Navigation Links HTML reused for both Desktop and Mobile
  const navLinksHTML = currentUser?.role === 'kitchen' ? `
  ...
  header.innerHTML = `
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
      <div style="display: flex; align-items: center; gap: 16px;">
        ...
        <nav class="header-nav" style="margin-left: 8px;">
          ${navLinksHTML}
        </nav>
      </div>
      ...
      <div style="display: flex; align-items: center; gap: 16px;">
        ...
        <div class="user-meta" style="display: flex; flex-direction: column; align-items: flex-end;">
